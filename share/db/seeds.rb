...
Content.delete_all
Content.create!(:title => "test1", :body => "h1. Test Plan 1!!\r\n\r\nA *simple* paragraph with\r\na line break, some _emphasis_ and a \"link\":http://redcloth.org\r\n\r\n* an item\r\n* and another\r\n\r\n# one\r\n# two\r\n", :display => true, :display_permit => true, :content_type => true, :customer_id => 1, :banner_size_id => 1, :banner_file_name => "DSC02203_320-240_momo.JPG", :banner_content_type => "image/jpeg", :banner_file_size => 362814, :summary => "h1. Give RedCloth a try!\r\n\r\nA *simple* paragraph with\r\na line break, some _emphasis_ and a \"link\":http://redcloth.org\r\n\r\n* an item\r\n* and another\r\n\r\n# one\r\n# two\r\n", :publish_at => DateTime.now, :close_at => DateTime.now + 10.months)
Content.create!(:title => "test2", :body => "h1. Test Plan 2!\r\n\r\nA *voluntourism* paragraph with\r\na line break, some _emphasis_ and a \"link\":http://redcloth.org\r\n\r\n* an item\r\n* and another\r\n\r\n# one\r\n# two\r\n", :display => true, :display_permit => true, :content_type => true, :customer_id => 1, :banner_size_id => 1, :banner_size_id => 1, :banner_file_name => "flower01_y_320_240.jpg", :banner_content_type => "image/jpeg", :banner_file_size => 203495, :summary => "h1. Give RedCloth a try!\r\n\r\nA *simple* paragraph with\r\na line break, some _emphasis_ and a \"link\":http://redcloth.org\r\n\r\n* an item\r\n* and another\r\n\r\n# one\r\n# two\r\n", :publish_at => DateTime.now, :close_at => DateTime.now + 10.months)
Content.create!(:title => "test3", :body => "h1. TestPlan3!\r\n\r\nA *simple* paragraph with\r\na line break, some _emphasis_ and a \"link\":http://redcloth.org\r\n\r\n* an item\r\n* and another\r\n\r\n# one\r\n# two\r\n", :display => true, :display_permit => true, :content_type => true, :customer_id => 1, :banner_size_id => 1, :banner_file_name => "yashi5_320_240.jpg", :banner_content_type => "image/jpeg", :banner_file_size => 270972, :summary => "h1. Give RedCloth a try!\r\n\r\nA *simple* paragraph with\r\na line break, some _emphasis_ and a \"link\":http://redcloth.org\r\n\r\n* an item\r\n* and another\r\n\r\n# one\r\n# two\r\n", :publish_at => DateTime.now, :close_at => DateTime.now + 10.months)
Content.create!(:title => "waiwai", :body => "h1. Test Plan 1!!\r\n\r\nA *simple* paragraph with\r\na line break, some _emphasis_ and a \"link\":http://redcloth.org\r\n\r\n* an item\r\n* and another\r\n\r\n# one\r\n# two\r\n", :display => true, :display_permit => true, :content_type => true, :customer_id => 1, :banner_size_id => 2, :banner_file_name => "iphone_001_t.jpg", :banner_content_type => "image/jpeg", :banner_file_size => 77701, :summary => "h1. Give RedCloth a try!\r\n\r\nA *simple* paragraph with\r\na line break, some _emphasis_ and a \"link\":http://redcloth.org\r\n\r\n* an item\r\n* and another\r\n\r\n# one\r\n# two\r\n", :publish_at => DateTime.now, :close_at => DateTime.now + 10.months)
Content.create!(:title => "picopico", :body => "h1. Test Plan 1!!\r\n\r\nA *simple* paragraph with\r\na line break, some _emphasis_ and a \"link\":http://redcloth.org\r\n\r\n* an item\r\n* and another\r\n\r\n# one\r\n# two\r\n", :display => true, :display_permit => true, :content_type => true, :customer_id => 1, :banner_size_id => 3, :banner_file_name => "lion_001_640_480.jpg", :banner_content_type => "image/jpeg", :banner_file_size => 151689, :summary => "h1. Give RedCloth a try!\r\n\r\nA *simple* paragraph with\r\na line break, some _emphasis_ and a \"link\":http://redcloth.org\r\n\r\n* an item\r\n* and another\r\n\r\n# one\r\n# two\r\n", :publish_at => DateTime.now, :close_at => DateTime.now + 10.months)
